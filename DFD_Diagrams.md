...
flowchart LR
    ND["Nguoi dung"]
    P0("0. He thong quan ly<br/>tai chinh ca nhan")
    QT["Quan tri vien"]

    ND -->|"TT dang ky"| P0
    ND -->|"TT dang nhap"| P0
    ND -->|"Du lieu giao dich thu chi"| P0
    ND -->|"File Excel nhap giao dich"| P0
    ND -->|"TT vi, so du ban dau"| P0
    ND -->|"Cau hinh ngan sach, muc tieu"| P0
    ND -->|"Cau hinh thong bao"| P0
    ND -->|"Tieu chi bao cao"| P0
    ND -->|"Cau hoi AI Chatbot"| P0

    P0 -->|"KQ xac thuc, OTP"| ND
    P0 -->|"Bao cao thu chi, so du vi"| ND
    P0 -->|"Canh bao ngan sach"| ND
    P0 -->|"KQ import giao dich"| ND
    P0 -->|"Phan hoi AI Chatbot"| ND
    P0 -->|"Thong bao he thong"| ND
    P0 -->|"File Excel xuat giao dich"| ND

    QT -->|"TT dang nhap quan tri"| P0
    QT -->|"Thao tac quan ly nguoi dung"| P0
    QT -->|"Giam sat AI Chatbot"| P0

    P0 -->|"DS va trang thai nguoi dung"| QT
    P0 -->|"Thong ke phan hoi AI"| QT
    P0 -->|"Log hoat dong"| QT
```
...
flowchart TB
    ND["Nguoi dung"]
    QT["Quan tri vien"]
    HT["He thong<br/>Scheduler"]

    P1("1.0<br/>Quan ly tai khoan")
    P2("2.0<br/>Quan ly vi")
    P3("3.0<br/>Quan ly thu chi")
    P4("4.0<br/>Quan ly ngan sach")
    P5("5.0<br/>Quan ly thong bao")
    P6("6.0<br/>Bao cao thong ke")
    P7("7.0<br/>AI Chatbot")
    P8("8.0<br/>Quan ly he thong")
    ...
    D6[("D6 Muc tieu")]
    D7[("D7 Thong bao")]
    D8[("D8 Cau hinh<br/>dinh ky")]
    D9[("D9 Lich su<br/>chat")]

    ND -->|"TT dang ky, dang nhap"| P1
    P1 -->|"KQ xac thuc, OTP"| ND

    ND -->|"TT vi, cau hinh"| P2
    P2 -->|"DS vi, so du"| ND

    ND -->|"Du lieu giao dich, file Excel"| P3
    P3 -->|"DS giao dich, file Excel xuat"| ND

    ND -->|"Cau hinh nguong theo vi/DM"| P4
    P4 -->|"DS canh bao chi tieu"| ND

    ND -->|"Cau hinh thong bao"| P5
    P5 -->|"DS thong bao"| ND

    ND -->|"Tieu chi bao cao"| P6
    P6 -->|"Bieu do, bang thong ke"| ND

    ND -->|"Cau hoi, yeu cau phan tich"| P7
    P7 -->|"Phan hoi NLP, phan tich, tu van"| ND

    QT -->|"Thao tac quan ly ND, giam sat AI"| P8
    P8 -->|"DS nguoi dung, thong ke AI"| QT

    HT -->|"Kich hoat GD dinh ky"| P3
    HT -->|"Kich hoat gui TB dinh ky"| P5

    P3 -.->|"GD moi -> Kiem tra NS"| P4
    P3 -.->|"GD moi -> Cap nhat MT"| P1
    P4 -.->|"Canh bao vuot NS"| P5

    P1 -->|"Luu TT tai khoan"| D1
    P1 -->|"Doc TT tai khoan"| D1
    P1 -->|"Luu muc tieu chung"| D6

    P2 -->|"Luu TT vi"| D2
    P2 -->|"Doc TT vi"| D2
    P2 -->|"Luu cau hinh NS"| D5
    P2 -->|"Luu muc tieu theo vi"| D6

    P3 -->|"Luu ban ghi GD"| D3
    P3 -->|"Doc ban ghi GD"| D3
    P3 -->|"Cap nhat so du vi"| D2
    P3 -->|"Doc danh muc"| D4
    P3 -->|"Luu cau hinh dinh ky"| D8
    P3 -->|"Doc cau hinh dinh ky"| D8

    P4 -->|"Doc cau hinh NS"| D5
    P4 -->|"Doc GD trong ky"| D3
    P4 -->|"Luu canh bao"| D7
    ...
    P7 -->|"Doc NS"| D5
    P7 -->|"Doc muc tieu"| D6
    P7 -->|"Luu lich su chat"| D9
    P7 -->|"Doc lich su chat"| D9

    P8 -->|"Doc TT nguoi dung"| D1
    P8 -->|"Doc phan hoi AI"| D9
```
...
flowchart TB
    ...
    P11("1.1 Dang ky<br/>tai khoan")
    P12("1.2 Dang nhap")
    P13("1.3 Cap nhat<br/>thong tin")
    P14("1.4 Thiet lap<br/>muc tieu")

    ND -->|"Email, mat khau, ho ten"| P11
    P11 -->|"Ma OTP"| ND
    P11 -->|"Ket qua dang ky"| ND
    P11 -->|"Luu TT tai khoan"| D1

    ND -->|"Email, mat khau"| P12
    P12 -->|"Doc TT xac thuc"| D1
    P12 -->|"Phien dang nhap"| ND

    ND -->|"TT ca nhan, tien te, nghe nghiep"| P13
    P13 -->|"Cap nhat TT"| D1
    P13 -->|"Ket qua cap nhat"| ND

    ND -->|"Ten MT, so tien, thoi han"| P14
    P14 -->|"Luu muc tieu"| D6
    P14 -->|"Ket qua thiet lap"| ND
```
...
flowchart TB
    ...
    P21("2.1 Tao vi")
    P22("2.2 Sua vi")
    P23("2.3 Cau hinh<br/>ngan sach theo vi")
    P24("2.4 Cau hinh<br/>muc tieu theo vi")

    ND -->|"Ten vi, so du ban dau"| P21
    P21 -->|"Luu TT vi"| D2
    P21 -->|"Ket qua tao vi"| ND

    ND -->|"TT vi cap nhat"| P22
    P22 -->|"TT vi"| D2
    P22 -->|"Ket qua sua vi"| ND

    ND -->|"Han muc, chu ky, nguong"| P23
    P23 -->|"Doc TT vi"| D2
    P23 -->|"Luu cau hinh NS"| D5
    P23 -->|"Ket qua cau hinh"| ND

    ND -->|"Ten MT, so tien, thoi han, vi"| P24
    P24 -->|"Doc TT vi"| D2
    P24 -->|"Luu MT theo vi"| D6
    P24 -->|"Ket qua cau hinh"| ND
```
...
flowchart TB
    ...
    P31("3.1 Tao giao dich<br/>thu cong")
    P32("3.2 Import tu<br/>file Excel")
    P33("3.3 Cau hinh khoan<br/>thu chi co dinh")
    P34("3.4 Xem DS<br/>giao dich")
    P35("3.5 Xuat du lieu<br/>ra file Excel")
    P36("3.6 Dieu phoi<br/>giao dich - P13")
    P37("3.7 Tao GD dinh ky<br/>tu dong - P11")

    ND -->|"So tien, danh muc, vi, ngay, ghi chu"| P31
    P31 -->|"Doc danh muc"| D4
    P31 -->|"Luu giao dich"| D3
    P31 -->|"Cap nhat so du"| D2
    P31 -->|"Ket qua tao GD"| ND
    P31 -.->|"GD thanh cong"| P36

    ND -->|"File Excel"| P32
    P32 -->|"Doc danh muc"| D4
    P32 -->|"Luu giao dich hop le"| D3
    P32 -->|"Cap nhat so du"| D2
    P32 -->|"Ket qua import, DS loi"| ND
    P32 -.->|"GD thanh cong"| P36

    ND -->|"Vi, so tien, DM, chu ky, trang thai"| P33
    P33 -->|"Luu cau hinh"| D8
    P33 -->|"Ket qua cau hinh"| ND

    HT -->|"Kiem tra CH den han"| P37
    P37 -->|"Doc CH active"| D8
    P37 -->|"Tao GD tu dong"| D3
    P37 -->|"Cap nhat so du"| D2
    P37 -->|"Cap nhat thoi diem tiep theo"| D8
    P37 -->|"TB giao dich dinh ky"| D7
    P37 -.->|"GD thanh cong"| P36

    P36 -->|"Doc cau hinh NS"| D5
    P36 -->|"Doc GD trong ky"| D3
    P36 -->|"Tao canh bao NS"| D7
    P36 -->|"Doc MT lien quan"| D6
    P36 -->|"Cap nhat % MT"| D6

    ND -->|"Bo loc: thoi gian, vi, DM, loai"| P34
    P34 -->|"Doc giao dich"| D3
    P34 -->|"DS giao dich phan trang"| ND

    ND -->|"Tieu chi xuat"| P35
    P35 -->|"Doc giao dich"| D3
    P35 -->|"File Excel"| ND
```
...
flowchart TB
    ...
    P41("4.1 Cau hinh nguong<br/>CB theo vi")
    P42("4.2 Cau hinh nguong<br/>CB theo danh muc")
    P43("4.3 Xem DS<br/>canh bao chi tieu")

    ND -->|"Vi, nguong canh bao"| P41
    P41 -->|"Luu cau hinh"| D5
    P41 -->|"Doc GD vi"| D3
    P41 -->|"Tao canh bao"| D7
    P41 -->|"Ket qua cau hinh"| ND

    ND -->|"Danh muc, nguong CB"| P42
    P42 -->|"Luu cau hinh"| D5
    P42 -->|"Doc GD theo DM"| D3
    P42 -->|"Tao canh bao"| D7
    P42 -->|"Ket qua cau hinh"| ND
...
flowchart TB
    ...
    P51("5.1 Bat/Tat<br/>thong bao")
    P52("5.2 Cau hinh thoi gian<br/>gui thong bao")
    P53("5.3 Xem DS<br/>thong bao")
    P54("5.4 Gui thong bao<br/>tu dong - P16")

    ND -->|"Trang thai bat/tat"| P51
    P51 -->|"Cap nhat cau hinh"| D7
    P51 -->|"Ket qua cap nhat"| ND

    ND -->|"Tan suat, thoi diem, loai BC"| P52
    P52 -->|"Luu cau hinh lich"| D7
    P52 -->|"Ket qua cau hinh"| ND

    ND -->|"Bo loc: thoi gian, loai, trang thai"| P53
    P53 -->|"Doc thong bao"| D7
    P53 -->|"DS thong bao phan trang"| ND

    HT -->|"Kiem tra TB den han"| P54
    P54 -->|"Doc cau hinh gui"| D7
    P54 -->|"Doc du lieu BC"| D3
    P54 -->|"Luu TB da gui"| D7
    P54 -->|"Email / TB noi bo"| ND
```
...
flowchart TB
    ...
    P61("6.1 Bao cao thong ke<br/>chi tieu theo vi")
    P62("6.2 Bao cao thong ke<br/>chi tieu theo danh muc")
    P63("6.3 Bao cao thong ke<br/>chi tieu theo thoi gian")

    ND -->|"Khoang thoi gian"| P61
    P61 -->|"Doc giao dich"| D3
    P61 -->|"Doc TT vi"| D2
    P61 -->|"Bieu do, bang TK"| ND

    ND -->|"Khoang thoi gian"| P62
    P62 -->|"Doc giao dich"| D3
    P62 -->|"Doc danh muc"| D4
    P62 -->|"Bieu do, bang TK"| ND

    ND -->|"Khoang thoi gian"| P63
    P63 -->|"Doc giao dich"| D3
    P63 -->|"Bieu do, bang TK"| ND
```
...
flowchart TB
    ...
    P71("7.1 Tra loi<br/>cau hoi NLP")
    P72("7.2 Phan tich<br/>xu huong chi tieu")
    P73("7.3 Tu van<br/>tai chinh")

    ND -->|"Cau hoi"| P71
    P71 -->|"Truy van du lieu"| D3
    P71 -->|"Luu/doc lich su"| D9
    P71 -->|"Cau tra loi NLP"| ND

    ND -->|"Yeu cau phan tich"| P72
    P72 -->|"Doc GD theo ky"| D3
    P72 -->|"Doc ngan sach"| D5
    P72 -->|"Luu/doc lich su"| D9
    P72 -->|"Ket qua phan tich"| ND

    ND -->|"Yeu cau tu van"| P73
    P73 -->|"Doc lich su GD"| D3
    P73 -->|"Doc NS, MT"| D5
    P73 -->|"Doc muc tieu"| D6
    P73 -->|"Luu/doc lich su"| D9
    P73 -->|"Noi dung tu van"| ND
```
...
flowchart TB
    ...
    P81("8.1 Thong ke<br/>danh sach nguoi dung")
    P82("8.2 Thong ke<br/>phan hoi AI Chatbot")

    QT -->|"Tieu chi thong ke"| P81
    P81 -->|"Doc TT nguoi dung"| D1
    P81 -->|"DS va trang thai ND"| QT

    QT -->|"Tieu chi thong ke"| P82
    P82 -->|"Doc lich su chat"| D9
