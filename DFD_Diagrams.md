...
flowchart TB
    ...
    P21("2.1 Tạo ví")
    P22("2.2 Sửa ví")
    P23("2.3 Cấu hình<br/>ngan sach theo ví")
...
flowchart TB
    ...
    ND -->|"Số tiền, danh mục, vi, ngày, ghi chú"| P31
    P31 -->|"Đọc danh mục"| D4
    ...
    ND -->|"Bộ lọc: thời gian, vi, DM, loại"| P34
...
flowchart TB
    ...
    P43("4.3 Xem DS<br/>cảnh báo chi tieu")
...
flowchart TB
    ...
    P52("5.2 Cấu hình thời gian<br/>gui thông báo")
    P53("5.3 Xem DS<br/>thông báo")
    P54("5.4 Gui thông báo<br/>tự động - P16")
